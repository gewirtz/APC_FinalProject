...
MNIST_DEPS = processing/mnist_load_images.cc processing/mnist_load_labels.cc processing/mnist_count_images.cc processing/ppm_load_images.cc processing/ppm_load_labels.cc
