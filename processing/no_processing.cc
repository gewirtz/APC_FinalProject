...
class no_processing : private data_processor{
  public:
    no_processing(){
      ...
      data_train=new vector<arma::mat >*; //Check w Jeffrey - or should we just call Mat() constructor here?
      data_test=new vector<arma::mat >*;
  ...
  void set_data_train(vector<arma::mat >* d_train){
      //Same across all derived processing classes
      data_train=d_train;

    };
  
  void set_data_test(vector<arma::mat >* d_test){
      //Same across all derived processing classes
      data_test=d_test;
...
vector<arma::mat> data_train; //This will be the processed data for each class
vector<arma::mat> data_test; //This will be the processed data for each class
